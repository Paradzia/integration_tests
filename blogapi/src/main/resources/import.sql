...
insert into user (id, account_status, email, first_name, last_name) values (null, 'REMOVED', 'konrad@domain.com', 'konrad', 'matthew')

insert into blog_post values (null, 'test post by the first dude', 1)
insert into blog_post values (null, 'Test post by some guy', 3)
insert into blog_post values (null, 'Test post by some removed guy', 4)
